...
REM
REM Generated by Vivado on Fri May 29 13:23:27 +0530 2026
...
echo "xvlog --incr --relax -prj atm_tb_vlog.prj"
call xvlog  --incr --relax -prj atm_tb_vlog.prj -log xvlog.log
